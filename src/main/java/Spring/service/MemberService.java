...
public class MemberService {
    ...
    public void membersave(MemberDto memberDto) {
        ...
        String encoderpass = passwordEncoder.encode(memberDto.getMember_pw());

        memberDto.setMember_pw(encoderpass);
    ...
    public MemberDto memberlogin(MemberDto logindto) {
        ...
        for(MemberEntity temp : memberEntityList) {
            ...
            if(temp.getMember_id().equals(logindto.getMember_id())
                && passwordEncoder.matches(logindto.getMember_pw(), temp.getMember_pw())) {
